...
function renderizarProductos(productos) {
    ...
    productos.forEach(producto => {
        ...
        const imgHtml = producto.imagen
            ...
            : `<i class="bi ${iconos[producto.idCategoria] || 'bi-box-seam-fill'}"></i>`;
        div.innerHTML = `
            <div class="prod-img">
                ${imgHtml}
            </div>
            <div class="prod-body">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; margin-top:0.35rem;">
                    ...
                    <button class="prod-add" onclick="Carrito.agregar({idProducto: ${producto.idProducto}, nombreProducto: '${producto.nombreProducto.replace(/'/g, "\\'")}', precio: ${producto.precio}, imagen: '${(producto.imagen || '').replace(/'/g, "\\'")}'}, 1)">
